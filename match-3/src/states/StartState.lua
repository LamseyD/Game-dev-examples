...
function StartState:init()
    ...
    self.colors = {
        [1] = {0.851, 0.341, 0.388, 1},
        [2] = {0.373, 0.804, 0.894, 1},
        [3] = {0.984, 0.949, 0.212, 1},
        [4] = {0.463, 0.259, 0.541, 1},
        [5] = {0.600, 0.898, 0.314, 1},
        [6] = {0.875, 0.443, 0.149, 1}
    }
...
function StartState:drawOptions(y)
    ...
    if self.currentMenuItem == 1 then
        ...
        love.graphics.setColor(0.188, 0.376, 0.510, 1)
    end
    ...
    if self.currentMenuItem == 2 then
        love.graphics.setColor(0.388, 0.608, 255, 1)
    else
        love.graphics.setColor(0.188, 0.376, 0.510, 1)
    end
